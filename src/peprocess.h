...
public:
	...
	void extractReadsToFile(int cycle,int thread_index,vector<string> r1,vector<string> r2,int fileReadsNum,int& reads_number,string position,int& output_index,bool gzFormat,bool done);
